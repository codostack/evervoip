...
function Ornament({ icon, label, color, gradient, ropeH, delay }) {
  ...
  className={`pt-6 transition-all duration-700 ${
    visible ? "opacity-100 translate-y-0 animate-floatUp" : "opacity-0 translate-y-8"
  }`}
>
  {/* Main Heading */}
  ...
  <div className="flex gap-3 ml-[-80px]">
    ...
    <button className="border border-blue-600 text-blue-600 font-semibold px-6 py-3 rounded-md hover:bg-blue-600 hover:text-white transition">
      Learn More
    </button>
  </div>
</div>
